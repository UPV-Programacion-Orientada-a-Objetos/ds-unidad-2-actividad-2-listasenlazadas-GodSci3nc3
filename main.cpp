...
int main() {
    ...
    std::cout << "\n--- Simulando el ejemplo del README ---" << std::endl;
    
    TramaBase* trama1 = new TramaLoad('H');
    trama1->procesar(&carga, &rotor);
    delete trama1;
    
    TramaBase* trama2 = new TramaLoad('O');
    trama2->procesar(&carga, &rotor);
    delete trama2;
    
    TramaBase* trama3 = new TramaLoad('L');
    trama3->procesar(&carga, &rotor);
    delete trama3;
    
    TramaBase* trama4 = new TramaMap(2);
    trama4->procesar(&carga, &rotor);
    delete trama4;
    
    TramaBase* trama5 = new TramaLoad('A');
    trama5->procesar(&carga, &rotor);
    delete trama5;
    
    TramaBase* trama6 = new TramaLoad(' '); 
    trama6->procesar(&carga, &rotor);
    delete trama6;
    
    TramaBase* trama7 = new TramaLoad('W');
    trama7->procesar(&carga, &rotor);
    delete trama7;
    
    TramaBase* trama8 = new TramaMap(-2);
    trama8->procesar(&carga, &rotor);
    delete trama8;
    
    TramaBase* trama9 = new TramaLoad('O');
    trama9->procesar(&carga, &rotor);
    delete trama9;
    
    TramaBase* trama10 = new TramaLoad('R');
    trama10->procesar(&carga, &rotor);
    delete trama10;
    
    TramaBase* trama11 = new TramaLoad('L');
    trama11->procesar(&carga, &rotor);
    delete trama11;
    
    TramaBase* trama12 = new TramaLoad('D');
    trama12->procesar(&carga, &rotor);
    delete trama12;
